<x-app-layout>
  ...
  <div class="p-5 dark:text-white">
    <h1 class="mb-3 text-xl font-bold">Update Client</h1>
    <form method="POST" action="{{ route('clients.update', $client->id) }}">
      ...
      <div class="mb-3">
        ...
        <input type="text" id="contact_name" name="contact_name"
          ...
          placeholder="Contact Name" value="{{ old('contact_name', $client->contact_name) }}">
        @error('contact_name')
      ...
      <div class="mb-3">
        ...
        <input type="number" id="contact_phone_number" name="contact_phone_number"
          class="block w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
          placeholder="Phone Number" value="{{ old('contact_phone_number', $client->contact_phone_number) }}">
      ...
      <div class="mb-3">
        ...
        <input type="email" id="contact_email" name="contact_email"
          class="block w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
          placeholder="Contact Email" value="{{ old('contact_email', $client->contact_email) }}">
        @error('contact_email')
          <p class="mt-1 text-xs text-red-400"> {{ $message }}</p>
        @enderror
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" id="company_address" name="company_address"
          class="block w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
          placeholder="Company Address" value="{{ old('company_address', $client->company_address) }}">
      ...
      <div class="mb-3">
        ...
        <input type="text" id="company_city" name="company_city"
          class="block w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
          placeholder="Company City" value="{{ old('company_city', $client->company_city) }}">
        @error('company_city')
          <p class="mt-1 text-xs text-red-400"> {{ $message }}</p>
        @enderror
      </div>
      ...
      <div class="mb-7">
        ...
        <input type="number" id="company_zip" name="company_zip"
          class="block w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
          placeholder="Company Zip" value="{{ old('company_zip', $client->company_zip) }}">
        @error('company_zip')
          <p class="mt-1 text-xs text-red-400"> {{ $message }}</p>
        @enderror
      </div>
